...
/**
  ******************************************************************************
  * @file  : b_l4s5i_iot01a.c (Patched to include SENSOR_IO)
...
/** @defgroup B_L4S5I_IOT01A B_L4S5I_IOT01A
 * @{
 */

/** @defgroup B_L4S5I_IOT01A_LOW_LEVEL B_L4S5I_IOT01A LOW LEVEL
...
/** @defgroup B_L4S5I_IOT01A_LOW_LEVEL_Private_Defines B_L4S5I_IOT01A LOW LEVEL Private Defines
 * @{
 */

/** @defgroup B_L4S5I_IOT01A_LOW_LEVEL_FunctionPrototypes B_L4S5I_IOT01A LOW LEVEL Private Function Prototypes
 * @{
 */
...
/** @defgroup B_L4S5I_IOT01A_LOW_LEVEL_Private_Variables B_L4S5I_IOT01A LOW LEVEL Private Variables
 * @{
 */
...
{
  return (int32_t)__B_L4S5I_IOT01A_BSP_VERSION;
}
...
static void USART2_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  */
    ...
    PD6     ------> USART2_RX
    */
    GPIO_InitStruct.Pin = BUS_USART2_CTS_GPIO_PIN;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = BUS_USART2_CTS_GPIO_AF;
    HAL_GPIO_Init(BUS_USART2_CTS_GPIO_PORT, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = BUS_USART2_RTS_GPIO_PIN;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = BUS_USART2_RTS_GPIO_AF;
    HAL_GPIO_Init(BUS_USART2_RTS_GPIO_PORT, &GPIO_InitStruct);
...
static void USART2_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PD6     ------> USART2_RX
    */
    HAL_GPIO_DeInit(BUS_USART2_CTS_GPIO_PORT, BUS_USART2_CTS_GPIO_PIN);

    HAL_GPIO_DeInit(BUS_USART2_RTS_GPIO_PORT, BUS_USART2_RTS_GPIO_PIN);
