...
#define BUS_USART2_CTS_GPIO_CLK_ENABLE() __HAL_RCC_GPIOD_CLK_ENABLE()
#define BUS_USART2_CTS_GPIO_AF GPIO_AF7_USART2
#define BUS_USART2_CTS_GPIO_CLK_DISABLE() __HAL_RCC_GPIOD_CLK_DISABLE()
#define BUS_USART2_CTS_GPIO_PORT GPIOD
#define BUS_USART2_CTS_GPIO_PIN GPIO_PIN_3
#define BUS_USART2_RTS_GPIO_AF GPIO_AF7_USART2
#define BUS_USART2_RTS_GPIO_CLK_DISABLE() __HAL_RCC_GPIOD_CLK_DISABLE()
#define BUS_USART2_RTS_GPIO_PIN GPIO_PIN_4
#define BUS_USART2_RTS_GPIO_CLK_ENABLE() __HAL_RCC_GPIOD_CLK_ENABLE()
#define BUS_USART2_RTS_GPIO_PORT GPIOD
#define BUS_USART2_TX_GPIO_AF GPIO_AF7_USART2
#define BUS_USART2_TX_GPIO_PIN GPIO_PIN_5
#define BUS_USART2_TX_GPIO_CLK_ENABLE() __HAL_RCC_GPIOD_CLK_ENABLE()
#define BUS_USART2_TX_GPIO_PORT GPIOD
#define BUS_USART2_TX_GPIO_CLK_DISABLE() __HAL_RCC_GPIOD_CLK_DISABLE()
#define BUS_USART2_RX_GPIO_PORT GPIOD
#define BUS_USART2_RX_GPIO_CLK_ENABLE() __HAL_RCC_GPIOD_CLK_ENABLE()
#define BUS_USART2_RX_GPIO_CLK_DISABLE() __HAL_RCC_GPIOD_CLK_DISABLE()
#define BUS_USART2_RX_GPIO_PIN GPIO_PIN_6
